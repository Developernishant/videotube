...
export const YOUTUBE_VID_API =
  ...
  "https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=18&hl=pa&relevanceLanguage=pa&regionCode=IN&videoCategoryId=10&key=" +
  YOUTUBE_API_KEY;
...
export const getYoutubeCommentApi = (videoId) =>
  `https://www.googleapis.com/youtube/v3/commentThreads?key=${YOUTUBE_API_KEY}+&textFormat=plainText&part=snippet&videoId=${videoId}&maxResults=28`;
